...
function About() {
    return (
        <div id="About">
            ...
            <p>
                <em>Forever Home</em> is here to help! We provide a free service with the mission to help connect adoption agencies with interested customers. We want to help more pets spend long, happy lives while bringing joy to loving families.
            </p>
